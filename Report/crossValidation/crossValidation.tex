...
Cross validation is a technique for model validation. In this section, we instead consider a class of methods that estimate the
...
held out observations
 ...
 There is several options for Cross Validation and Validation set approach, of them will be described in this chapter.
